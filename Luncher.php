...
.","parse_mode" =>"HTML",'reply_markup' => array(
        'keyboard' => array(array('To All'),array('help','Members','mutelist'),array("settings")),
...
Get Out Of Here Idiot🖕
--------------------------------
شما در لیست سیاه قرار دارید " ,"parse_mode" =>"HTML"));	
}
    }
    else if($rpto !="" && $chat_id==$admin){
...
if($chat_id==$admin){
  apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" => ' سلام حوش آمدید, برای اشنا شدن با من دکمه help را بفشارید
...
.', 'reply_markup' => array(
        'keyboard' => array(array('Clean Members ','Clean Mutelist'),array('Back')),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
...
.', 'reply_markup' => array(
    ...
    else if ($text == "Clean Mutelist" && $chat_id==$admin) {
        ...
        'resize_keyboard' => true)));
    		...
    		apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" => 'قربان برای اشنایی با من دکمه help را بفشارید ,سلام خوش امدید
.', 'reply_markup' => array(
        'keyboard' => array(array('To All'),array('help','Members','mutelist'),array("settings")),
        'one_time_keyboard' => true,
        'selective' => true,
    ...
    else if ($text =="To All"  && $chat_id == $admin && $booleans[0]=="false") {
...
.","parse_mode" =>"HTML",'reply_markup' => array(
	...
	}else if($text == "mutelist" && $chat_id == $admin ){
