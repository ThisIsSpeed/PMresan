<?php
define('BOT_TOKEN', '225431397:AAHN-j1LbLV06rjFK7u-DY5WiLRkUC-u38Y');
...
.', 'reply_markup' => array(
        'keyboard' => array(array('Clean Members ','Clean Banlist'),array('Back')),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
...
.', 'reply_markup' => array(
    ...
    else if ($text == "Clean Banlist" && $chat_id==$admin) {
...
.","parse_mode" =>"HTML",'reply_markup' => array(
	...
	}else if($text == "Banlist" && $chat_id == $admin ){
